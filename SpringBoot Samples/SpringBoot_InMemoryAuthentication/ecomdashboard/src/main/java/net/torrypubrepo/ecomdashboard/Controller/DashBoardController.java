 ...
 */
@Controller
public class DashBoardController implements Branch_MetaData
{
    @Autowired
    ...
    //@GetMapping(value={"/", "/index", "index.html", "home", "/home"})
    ...
    @GetMapping(value={"/home/branches"}) //, "/branches", "/home/branchreport.html"
